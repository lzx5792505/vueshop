...
tdist.getLev1 = function() {
    for(var one = [], i=1; i<100; i++){
        var str = "0000";
        var one_id = i<10? "0"+i+str : i+str;

        var n = this['100000'];
        if(typeof n[one_id]!="undefined")
        {
            one.push({
                id:one_id,
                text:n[one_id]
...
tdist.getLev2 = function (one_id) {
    if(one_id==""){
        return ''
    }
    // var str = one_id.substr(0,2);

    for(var two = [], i=1; i<100; i++){
        var str = one_id.substr(0,2);
        var two_id = ''

        two_id = str+ (i<10 ? '0'+i+'00' : i+'00')

        var n = this[one_id]
        if(typeof n[two_id]!="undefined"){
            two.push({
                id:two_id,
                text:n[two_id]
            })
...
tdist.getLev3 = function (two_id) {
    ...
    for(var i=1; i<100; i++){
        var str = two_id.substr(0,4);
        var three_id = ''

        three_id = str+ (i<10 ? '0'+i : i)

        var n = this[two_id]
        if(typeof n[three_id]!="undefined"){
            three.push({
                id:three_id,
                text:n[three_id]
            })
